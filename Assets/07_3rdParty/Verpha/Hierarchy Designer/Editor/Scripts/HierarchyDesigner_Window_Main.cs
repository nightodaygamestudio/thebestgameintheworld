...
{
    public class HierarchyDesigner_Window_Main : EditorWindow
    {
        #region Properties
        #region GUI
        ...
        private const float lineDivisorWidth = 140f;
        ...
        #endregion
        #region Conditions
        private bool utilitiesFoldout = false;
        private bool configurationsFoldout = false;
        #endregion
        #region Home
        ...
        private const float defaultFolderButtonWidth = 60;
        ...
        private const float generalSettingstoggleLabelWidth = 290;
        ...
        {
            "Hierarchy Designer/Open Main Window",
            "Hierarchy Designer/Open Folder Window",
            "Hierarchy Designer/Open Separator Window",
            "Hierarchy Designer/Open Presets Window",
            "Hierarchy Designer/Open Tools Window",
        ...
        {
            #region Header
            HierarchyDesigner_Shared_GUI.GetHierarchyDesignerGUIStyles(out leftPanel, out titleLabel, out versionLabel, out rightPanel, out categoryLabel, out primaryButtonStyle, out secondaryButtonStyle, out contentPanel, out contentLabel, out fieldsLabel, out unassignedLabel, out messageLabel);
            EditorGUILayout.BeginHorizontal();
            #endregion

            #region Body
            #region Left Panel
            EditorGUILayout.BeginVertical(leftPanel);
            ...
            buttonsScroll = EditorGUILayout.BeginScrollView(buttonsScroll, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
        ...
        private void DrawSeparatorsWindow()
        {
            ...
            {
                EditorGUILayout.LabelField("No separators found. Please create a new folder.", unassignedLabel);
            }
            EditorGUILayout.EndScrollView();
            #endregion
        ...
        private void DrawFolders(int index, string key, HierarchyDesigner_Configurable_Folder.HierarchyDesigner_FolderData folderData, int position, int totalItems)
        {
            ...
            EditorGUILayout.LabelField($"{index}) {folderData.Name}", fieldsLabel, GUILayout.Width(folderLabelWidth + extraFolderLabelWidthOffset));
            EditorGUI.BeginChangeCheck();
            ...
            if (GUILayout.Button("Create", GUILayout.Width(defaultFolderButtonWidth)))
            {
                CreateFolderGameObject(folderData);
            }
            if (GUILayout.Button("Remove", GUILayout.Width(defaultFolderButtonWidth)))
            {
                RemoveFolder(key);
            }
            EditorGUILayout.EndHorizontal();
        ...
        private void DrawSeparators(int index, string key, HierarchyDesigner_Configurable_Separator.HierarchyDesigner_SeparatorData separatorData, int position, int totalItems)
        {
            ...
            EditorGUILayout.LabelField($"{index}) {separatorData.Name}", fieldsLabel, GUILayout.Width(separatorLabelWidth + extraSeparatorLabelWidthOffset));
            EditorGUI.BeginChangeCheck();
        ...
        private void DrawDesignSettingsComponentIcons()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempComponentIconsSize = HierarchyDesigner_Shared_GUI.DrawSlider("Component Icons Size", designSettingslabelWidth, tempComponentIconsSize, 0.5f, 1.0f);
            tempComponentIconsSpacing = HierarchyDesigner_Shared_GUI.DrawSlider("Component Icons Spacing", designSettingslabelWidth, tempComponentIconsSpacing, 0.0f, 10.0f);
            tempComponentIconsOffset = HierarchyDesigner_Shared_GUI.DrawIntSlider("Component Icons Offset", designSettingslabelWidth, tempComponentIconsOffset, 15, 30);
        ...
        private void DrawDesignSettingsTag()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempTagColor = HierarchyDesigner_Shared_GUI.DrawColorField("Tag Color", designSettingslabelWidth, tempTagColor);
            tempTagFontSize = HierarchyDesigner_Shared_GUI.DrawIntSlider("Tag Font Size", designSettingslabelWidth, tempTagFontSize, 7, 21);
            tempTagFontStyle = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tag Font Style", designSettingslabelWidth, tempTagFontStyle);
            tempTagTextAnchor = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tag Text Anchor", designSettingslabelWidth, tempTagTextAnchor);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsLayer()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempLayerColor = HierarchyDesigner_Shared_GUI.DrawColorField("Layer Color", designSettingslabelWidth, tempLayerColor);
            tempLayerFontSize = HierarchyDesigner_Shared_GUI.DrawIntSlider("Layer Font Size", designSettingslabelWidth, tempLayerFontSize, 7, 21);
            tempLayerFontStyle = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Layer Font Style", designSettingslabelWidth, tempLayerFontStyle);
            tempLayerTextAnchor = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Layer Text Anchor", designSettingslabelWidth, tempLayerTextAnchor);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsTagAndLayer()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempTagLayerOffset = HierarchyDesigner_Shared_GUI.DrawIntSlider("Tag, Layer Offset", designSettingslabelWidth, tempTagLayerOffset, 0, 20);
            tempTagLayerSpacing = HierarchyDesigner_Shared_GUI.DrawIntSlider("Tag, Layer Spacing", designSettingslabelWidth, tempTagLayerSpacing, 0, 20);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsHierarchyTree()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempHierarchyTreeColor = HierarchyDesigner_Shared_GUI.DrawColorField("Tree Color", designSettingslabelWidth, tempHierarchyTreeColor);
            tempTreeBranchImageType_I = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tree Branch Image Type I", designSettingslabelWidth, tempTreeBranchImageType_I);
            tempTreeBranchImageType_L = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tree Branch Image Type L", designSettingslabelWidth, tempTreeBranchImageType_L);
            tempTreeBranchImageType_T = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tree Branch Image Type T", designSettingslabelWidth, tempTreeBranchImageType_T);
            tempTreeBranchImageType_TerminalBud = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Tree Branch Image Type Terminal Bud", designSettingslabelWidth, tempTreeBranchImageType_TerminalBud);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsHierarchyLines()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempHierarchyLineColor = HierarchyDesigner_Shared_GUI.DrawColorField("Line Color", designSettingslabelWidth, tempHierarchyLineColor);
            tempHierarchyLineThickness = HierarchyDesigner_Shared_GUI.DrawIntSlider("Line Thickness", designSettingslabelWidth, tempHierarchyLineThickness, 1, 3);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsFolder()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempFolderDefaultTextColor = HierarchyDesigner_Shared_GUI.DrawColorField("Default Folder Text Color", designSettingslabelWidth, tempFolderDefaultTextColor);
            tempFolderDefaultFontSize = HierarchyDesigner_Shared_GUI.DrawIntSlider("Default Folder Font Size", designSettingslabelWidth, tempFolderDefaultFontSize, 7, 21);
            tempFolderDefaultFontStyle = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Default Folder Font Style", designSettingslabelWidth, tempFolderDefaultFontStyle);
            tempFolderDefaultImageColor = HierarchyDesigner_Shared_GUI.DrawColorField("Default Folder Image Color", designSettingslabelWidth, tempFolderDefaultImageColor);
            tempFolderDefaultImageType = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Default Folder Image Type", designSettingslabelWidth, tempFolderDefaultImageType);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsSeparator()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempSeparatorDefaultTextColor = HierarchyDesigner_Shared_GUI.DrawColorField("Default Separator Text Color", designSettingslabelWidth, tempSeparatorDefaultTextColor);
            tempSeparatorDefaultIsGradientBackground = HierarchyDesigner_Shared_GUI.DrawToggle("Default Is Gradient Background", designSettingslabelWidth, tempSeparatorDefaultIsGradientBackground);
            tempSeparatorDefaultBackgroundColor = HierarchyDesigner_Shared_GUI.DrawColorField("Default Separator Background Color", designSettingslabelWidth, tempSeparatorDefaultBackgroundColor);
            tempSeparatorDefaultBackgroundGradient = HierarchyDesigner_Shared_GUI.DrawGradientField("Default Separator Background Gradient", designSettingslabelWidth, tempSeparatorDefaultBackgroundGradient != null ? tempSeparatorDefaultBackgroundGradient : new Gradient());
            tempSeparatorDefaultFontSize = HierarchyDesigner_Shared_GUI.DrawIntSlider("Default Separator Font Size", designSettingslabelWidth, tempSeparatorDefaultFontSize, 7, 21);
            tempSeparatorDefaultFontStyle = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Default Separator Font Style", designSettingslabelWidth, tempSeparatorDefaultFontStyle);
            tempSeparatorDefaultTextAnchor = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Default Separator Text Anchor", designSettingslabelWidth, tempSeparatorDefaultTextAnchor);
            tempSeparatorDefaultImageType = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Default Separator Image Type", designSettingslabelWidth, tempSeparatorDefaultImageType);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
        ...
        private void DrawDesignSettingsLock()
        {
            ...
            EditorGUILayout.Space(contentLabelSpacing);
            EditorGUI.BeginChangeCheck();
            tempLockColor = HierarchyDesigner_Shared_GUI.DrawColorField("Lock Color", designSettingslabelWidth, tempLockColor);
            tempLockFontSize = HierarchyDesigner_Shared_GUI.DrawIntSlider("Lock Font Size", designSettingslabelWidth, tempLockFontSize, 7, 21);
            tempLockFontStyle = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Lock Font Style", designSettingslabelWidth, tempLockFontStyle);
            tempLockTextAnchor = HierarchyDesigner_Shared_GUI.DrawEnumPopup("Lock Text Anchor", designSettingslabelWidth, tempLockTextAnchor);
            if (EditorGUI.EndChangeCheck()) { designSettingsHasModifiedChanges = true; }
            EditorGUILayout.EndVertical();
        }
