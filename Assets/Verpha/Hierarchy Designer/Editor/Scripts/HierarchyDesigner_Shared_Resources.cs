...
namespace Verpha.HierarchyDesigner
{
    ...
    {
        #region General
        private static readonly string defaultFontName = "Hierarchy Designer Default Font";
        ...
        public static readonly Font DefaultFont = HierarchyDesigner_Shared_TextureLoader.LoadFont(defaultFontName);
